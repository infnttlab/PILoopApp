...
import it.ttlab.piloopapp.deviceinfo.io.Os;
import it.ttlab.piloopapp.deviceinfo.io.Libcore;
...
public class DirProperty implements Property {
    ...
    private StructStat getFileInfo(File file) throws Exception {
        if(Build.VERSION.SDK_INT <= Build.VERSION_CODES.KITKAT) {
            Os os = Libcore.os;
            it.ttlab.piloopapp.deviceinfo.io.StructStat fileInfo = os.lstat(file.getAbsolutePath());
    ...
    private static class StructStat {
        ...
        public StructStat(it.ttlab.piloopapp.deviceinfo.io.StructStat info) {
